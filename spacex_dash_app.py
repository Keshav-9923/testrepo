...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', options=[{'label': 'All-Sites', 'value': 'ALL'}, {
                                    'label': 'Cape Canaveral Space Launch Complex LC-40', 'value': 'CCAFS LC-40'},
                                                                          {
                                                                              'label': 'Cape Canaveral Space Launch Complex SLC-40',
                                                                              'value': 'CCAFS SLC-40'},
                                                                          {
                                                                              'label': 'Kennedy Space Center Launch Complex 39',
                                                                              'value': 'KSC LC-39A'},
                                                                          {
                                                                              'label': 'Vandenberg AFB Space Launch Complex 4',
                                                                              'value': 'VAFB SLC-4E'}],
